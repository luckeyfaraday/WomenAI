...
- Grounding exercises and support

**🛡️ Priority Safety Resources**
...
**Features:**
- ✅ Basic cycle tracking (up to 10 entries/month)
- ✅ Mood logging (up to 10 entries/month)
...
**Best for:** Women who want comprehensive health tracking and unlimited AI support
...
- ✅ **AI-powered cycle predictions** with 95%+ accuracy
- ✅ **Personalized health reports** (monthly PDF summaries)
- ✅ **Video consultations** with wellness coaches (2/month)
- ✅ **Custom AI training** on your unique health patterns
- ✅ **Family sharing** (up to 3 accounts)
- ✅ **API access** for health app integrations
- ✅ **White-glove support** (priority chat & phone)
- ✅ **Exclusive community** access

**Best for:** Women who want the most advanced AI health insights and personalized support
...
- Traditional therapy: $100-200/session
...
- Better understand your body and patterns
...
### Benefits List
✨ Unlimited AI chat support - talk anytime, about anything
📊 Advanced health insights - understand your patterns
🔒 Complete privacy - your data, your control
💜 Empathetic support - built for women, by women
...
```
tier: premium
features: unlimited_chat,unlimited_tracking,analytics,export,priority_support
trial_days: 7
```
...
We've processed your cancellation. Your Premium access will continue until [end date].

Your data is safe and will remain accessible. You can reactivate anytime.
